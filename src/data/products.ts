import type { TonnageClass } from './carriers';

/**
 * BIH 产品数据库（Mock 数据）
 * 
 * 7 个品类：Buckets / Rack Buckets / Hydraulic Breakers / Quick Couplers / 
 *          Thumbs & Rippers / Earth Augers
 * 
 * 所有产品全部走 Get Quote 模式，暂不显示价格
 */
...
export interface Product {
  ...
  images: string[];                      // 多角度图片占位
  tonnageRange: [number, number];        // 适配吨位范围 [min, max]
  compatibleTonnageClasses: TonnageClass[];
  compatibleBrands: string[];            // 品牌 ID 列表
  specs: Record<string, string>;         // 技术参数
  specsFr: Record<string, string>;       // 技术参数（法语键名）
...
export const products: Product[] = [
  // ===== BUCKETS =====
  {
    ...
    images: [],
    tonnageRange: [12, 25],
    compatibleTonnageClasses: ['medium'],
    compatibleBrands: ['cat', 'john-deere', 'komatsu', 'kubota', 'volvo', 'hitachi', 'bobcat'],
    specs: {
      'Operating Weight': '580–920 kg',
      'Bucket Width': '900–1200 mm',
      'Capacity': '0.5–1.0 m³',
      'Cutting Edge Thickness': '20 mm Hardox 450',
      'Side Cutter Material': 'Hardox 450',
      'Tooth System': 'CAT J-Series or equivalent',
      'Pin Diameter': '65–80 mm (model dependent)',
    },
    specsFr: {
      'Poids opérationnel': '580–920 kg',
      'Largeur du godet': '900–1200 mm',
      'Capacité': '0,5–1,0 m³',
      'Épaisseur arête de coupe': '20 mm Hardox 450',
      'Matériau couteaux latéraux': 'Hardox 450',
      'Système de dents': 'CAT J-Series ou équivalent',
      'Diamètre des axes': '65–80 mm (selon modèle)',
    },
    material: { body: 'Q355 HSLA Steel', wearParts: 'Hardox 450' },
    certificates: ['CE', 'ISO 9001'],
    description: 'Engineered for general excavation, trenching, and loading in medium-class excavators. Full-penetration welds inspected per AWS D1.1. Cutting edges and side cutters in Hardox 450 for extended service life.',
    descriptionFr: 'Conçu pour l\'excavation générale, le creusement de tranchées et le chargement avec des excavateurs de classe moyenne. Soudures à pleine pénétration inspectées selon AWS D1.1. Arêtes et couteaux latéraux en Hardox 450 pour une durée de vie prolongée.',
    features: [
  ...
  },
  {
    ...
    images: [],
    tonnageRange: [25, 50],
    compatibleTonnageClasses: ['large'],
    compatibleBrands: ['cat', 'john-deere', 'komatsu', 'volvo', 'hitachi'],
    specs: {
      'Operating Weight': '1,200–2,800 kg',
      'Bucket Width': '1200–1800 mm',
      'Capacity': '1.2–3.0 m³',
      'Cutting Edge Thickness': '25 mm Hardox 450',
      'Side Cutter Material': 'Hardox 450',
      'Tooth System': 'CAT J-Series or equivalent',
      'Pin Diameter': '90–100 mm (model dependent)',
    },
    specsFr: {
      'Poids opérationnel': '1 200–2 800 kg',
      'Largeur du godet': '1200–1800 mm',
      'Capacité': '1,2–3,0 m³',
      'Épaisseur arête de coupe': '25 mm Hardox 450',
      'Matériau couteaux latéraux': 'Hardox 450',
      'Système de dents': 'CAT J-Series ou équivalent',
      'Diamètre des axes': '90–100 mm (selon modèle)',
    },
    material: { body: 'Q355 HSLA Steel', wearParts: 'Hardox 450' },
    certificates: ['CE', 'ISO 9001'],
    description: 'Built for high-production excavation and mass earthmoving. Reinforced box-section design with internal stiffeners. Ideal for quarry, mining, and heavy civil applications.',
    descriptionFr: 'Conçu pour l\'excavation à haute production et le terrassement de masse. Structure renforcée à section en caisson avec raidisseurs internes. Idéal pour carrières, mines et travaux civils lourds.',
    features: [
  ...
  },
  {
    ...
    images: [],
    tonnageRange: [1, 5],
    compatibleTonnageClasses: ['mini'],
    compatibleBrands: ['cat', 'john-deere', 'komatsu', 'kubota', 'volvo', 'hitachi', 'bobcat'],
    specs: {
      'Operating Weight': '45–180 kg',
      'Bucket Width': '300–600 mm',
      'Capacity': '0.03–0.15 m³',
      'Cutting Edge Thickness': '12 mm Hardox 450',
      'Tooth System': 'Mini-series teeth',
      'Pin Diameter': '30–45 mm (model dependent)',
    },
    specsFr: {
      'Poids opérationnel': '45–180 kg',
      'Largeur du godet': '300–600 mm',
      'Capacité': '0,03–0,15 m³',
      'Épaisseur arête de coupe': '12 mm Hardox 450',
      'Système de dents': 'Dents série mini',
      'Diamètre des axes': '30–45 mm (selon modèle)',
    },
    material: { body: 'Q355 HSLA Steel', wearParts: 'Hardox 450' },
    certificates: ['CE', 'ISO 9001'],
    description: 'Compact design for mini and micro excavators. Ideal for residential trenching, landscaping, and utility work. Available in multiple widths.',
    descriptionFr: 'Conception compacte pour mini et micro excavateurs. Idéal pour le creusement résidentiel, l\'aménagement paysager et les travaux de services publics. Disponible en plusieurs largeurs.',
    features: [
  ...
  // ===== RAKE / SKELETON BUCKETS =====
  {
    ...
    certificates: ['CE', 'ISO 9001'],
    description: 'Open-bar design for separating soil from rocks, roots, and debris. Ideal for land clearing, demolition sorting, and site preparation.',
    descriptionFr: 'Conception à barreaux ouverts pour séparer la terre des roches, racines et débris. Idéal pour le défrichage, le tri de démolition et la préparation de terrain.',
    features: [
    ...
    featuresFr: [
      'Dents en barre ronde Hardox 450 pour une résistance maximale à l\'usure',
      'Espacement des barreaux configurable selon les besoins de séparation',
  ...
  {
    id: 'rak-02',
    slug: 'skeleton-rake-bucket-25-50t',
    name: 'Skeleton Rake Bucket — Large Class',
    nameFr: 'Godet squelette à barreaux — Grande classe',
    category: 'rack-bucket',
    categoryLabel: 'Rake / Skeleton Buckets',
    categoryLabelFr: 'Godets squelettes / à barreaux',
    images: [],
    ...
    compatibleBrands: ['cat', 'john-deere', 'komatsu', 'volvo', 'hitachi'],
    specs: {
      'Operating Weight': '900–1,600 kg',
      'Bucket Width': '1500–2000 mm',
      'Bar Spacing': '75–100 mm (configurable)',
      'Bar Diameter': '40 mm Hardox 450 round bar',
      'Pin Diameter': '90–100 mm (model dependent)',
    },
    specsFr: {
      'Poids opérationnel': '900–1 600 kg',
      'Largeur du godet': '1500–2000 mm',
      'Espacement des barreaux': '75–100 mm (configurable)',
      'Diamètre des barreaux': '40 mm barre ronde Hardox 450',
      'Diamètre des axes': '90–100 mm (selon modèle)',
    },
    material: { body: 'Q355 HSLA Steel', wearParts: 'Hardox 450 bars' },
    certificates: ['CE', 'ISO 9001'],
    description: 'Heavy-duty rake bucket for large excavators. Designed for aggressive land clearing, demolition, and rock sorting applications.',
    descriptionFr: 'Godet squelette robuste pour grosses excavateurs. Conçu pour le défrichage intensif, la démolition et le tri de roches.',
    features: [
      '40 mm Hardox 450 tines',
      'Reinforced box-section side plates',
      'Heavy-duty hinge point brackets',
      'Custom bar spacing options',
    ],
    featuresFr: [
      'Dents Hardox 450 de 40 mm',
      'Plaques latérales renforcées à section en caisson',
  ...
  // ===== HYDRAULIC BREAKERS =====
  {
    ...
    images: [],
    tonnageRange: [5, 12],
    compatibleTonnageClasses: ['small'],
    compatibleBrands: ['cat', 'john-deere', 'komatsu', 'kubota', 'volvo', 'hitachi', 'bobcat'],
    specs: {
    ...
    certificates: ['CE', 'ISO 9001'],
    description: 'Compact hydraulic breaker for small excavators. Membrane-type accumulator for smooth operation and reduced hydraulic stress. Ideal for trenching, light demolition, and concrete removal.',
    descriptionFr: 'Brise-roche hydraulique compact pour petites excavateurs. Accumulateur à membrane pour un fonctionnement fluide et une réduction du stress hydraulique. Idéal pour le creusement de tranchées, la démolition légère et le retrait de béton.',
    features: [
    ...
    featuresFr: [
      'Système de graissage automatique pour un entretien réduit',
  ...
  },
  {
    ...
    images: [],
    tonnageRange: [12, 30],
    compatibleTonnageClasses: ['medium', 'large'],
    compatibleBrands: ['cat', 'john-deere', 'komatsu', 'volvo', 'hitachi'],
    specs: {
    ...
    material: { body: 'High-tensile alloy steel housing', wearParts: 'Heat-treated chisel tool' },
    certificates: ['CE', 'ISO 9001'],
    description: 'High-energy hydraulic breaker for primary demolition, quarry, and mining applications. Gas/oil charged accumulator for maximum impact consistency.',
    descriptionFr: 'Brise-roche hydraulique haute énergie pour la démolition primaire, les carrières et les applications minières. Accumulateur gaz/huile pour une constance d\'impact maximale.',
    features: [
  ...
  // ===== QUICK COUPLERS =====
  {
    ...
    images: [],
    tonnageRange: [5, 25],
    compatibleTonnageClasses: ['small', 'medium'],
    compatibleBrands: ['cat', 'john-deere', 'komatsu', 'kubota', 'volvo', 'hitachi', 'bobcat'],
    specs: {
    ...
    description: 'Switch attachments in seconds without leaving the cab. Dual-lock safety system with hydraulic primary and mechanical secondary lock. Meets EN 474 safety requirements.',
    descriptionFr: 'Changez d\'accessoire en quelques secondes sans quitter la cabine. Système de sécurité à double verrouillage avec verrouillage hydraulique principal et mécanique secondaire. Conforme aux exigences de sécurité EN 474.',
    features: [
    ...
    featuresFr: [
      'Sécurité à double verrouillage : hydraulique + mécanique de secours',
  ...
  // ===== HYDRAULIC THUMBS =====
  {
    ...
    certificates: ['CE', 'ISO 9001'],
    description: 'Pin-on hydraulic thumb for material handling, demolition sorting, and brush clearing. Full 180° rotation for maximum versatility.',
    descriptionFr: 'Pouce hydraulique à montage par axe pour la manutention de matériaux, le tri de démolition et le défrichage. Rotation complète de 180° pour une polyvalence maximale.',
    features: [
  ...
  // ===== RIPPERS =====
  {
    ...
    specs: {
      ...
      'Pin Diameter': '65–90 mm (model dependent)',
    },
    specsFr: {
      ...
      'Diamètre des axes': '65–90 mm (selon modèle)',
    },
    material: { body: 'Q355 HSLA Steel', wearParts: 'Hardox 450 shank tip' },
    certificates: ['CE', 'ISO 9001'],
    description: 'Single-shank ripper for breaking up frozen ground, hard clay, soft rock, and asphalt. Ideal for Canadian winter ground conditions.',
    descriptionFr: 'Dent de défonçage à tige unique pour briser le sol gelé, l\'argile dure, la roche tendre et l\'asphalte. Idéal pour les conditions de sol en hiver canadien.',
    features: [
    ...
    featuresFr: [
      ...
      'Logement de tige renforcé avec plaque d\'usure',
  ...
  // ===== EARTH AUGERS =====
  {
    ...
    certificates: ['CE', 'ISO 9001'],
    description: 'Planetary gear-driven auger unit for fence posts, sign poles, tree planting, and foundation piles. Multiple auger bit sizes available from 150 mm to 900 mm diameter.',
    descriptionFr: 'Unité de tarière à engrenages planétaires pour poteaux de clôture, poteaux de signalisation, plantation d\'arbres et pieux de fondation. Plusieurs tailles de mèche disponibles de 150 mm à 900 mm de diamètre.',
    features: [
    ...
    featuresFr: [
      'Boîte de vitesses planétaire pour un couple élevé à basse vitesse',
...
export function filterProducts(opts: {
  ...
  if (opts.brandId) {
    filtered = filtered.filter((p) => p.compatibleBrands.includes(opts.brandId!));
  }

  if (opts.tonnageClass) {
    filtered = filtered.filter((p) =>
      p.compatibleTonnageClasses.includes(opts.tonnageClass as TonnageClass)
    );
  }
...
/**
 * 根据当前语言返回本地化的产品字段
 * 当 lang === 'fr' 时使用法语字段，否则使用英语字段
 */
export function getLocalizedProduct(product: Product, lang: string) {
  const isFr = lang === 'fr';
  return {
    ...product,
    name: isFr ? product.nameFr : product.name,
    categoryLabel: isFr ? product.categoryLabelFr : product.categoryLabel,
    description: isFr ? product.descriptionFr : product.description,
    features: isFr ? product.featuresFr : product.features,
    specs: isFr ? product.specsFr : product.specs,
  };
}
